...
An offline-first full-stack application with React Native Expo mobile app and NestJS backend, featuring bidirectional sync powered by WatermelonDB.

⚠️ This is more of a Proof-Of-Concept to see if Mobile and Backend work together.
